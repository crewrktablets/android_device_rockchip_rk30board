...
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/rockchip/rk30board/prebuilt/etc/ppp,system/etc/ppp)

# Copy prebuilt usb_modeswitch.d files
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/rockchip/rk30board/prebuilt/etc/usb_modeswitch.d,system/etc/usb_modeswitch.d)

# Copy prebuilt hw libs
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/rockchip/rk30board/prebuilt/lib/hw,system/lib/hw)

# Copy prebuilt egl libs
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/rockchip/rk30board/prebuilt/lib/egl,system/lib/egl)

# Copy every prebuilt libs
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/rockchip/rk30board/prebuilt/lib,system/lib)

# Copy prebuilt modules
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/rockchip/rk30board/prebuilt/lib/modules,system/lib/modules)

# Copy Vendor firmware
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/rockchip/rk30board/prebuilt/etc/firmware,system/etc/firmware)

# Copy media
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/rockchip/rk30board/prebuilt/media,system/media)

# Copy keylayouts
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/rockchip/rk30board/prebuilt/usr/keylayout,system/usr/keylayout)
...
# copy the builder 
PRODUCT_COPY_FILES += \
	device/rockchip/rk30board/custom_boot.sh:custom_boot.sh
